...
import static com.sonaive.v2ex.util.LogUtils.LOGI;
import static com.sonaive.v2ex.util.LogUtils.makeLogTag;

/**
 * Sync adapter for v2ex data
 */
public class SyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String EXTRA_SYNC_REMOTE = "com.sonaive.v2ex.EXTRA_SYNC_REMOTE";;
